...
import { addNewProduct, deleteProduct, editProduct } from '../../redux/actions/general_actions';
...
const Main = () => {
  ...
  const handleEdit = () => {
    ...
    if (name === '' || cost === '') {
      ...
      dispatch(editProduct({ ...state.product }));
      handleOpenWarning('Se editó el producto de manera exitosa!', 'success');
    }
  }
  const handleDelete = () => {
  ...
  return (
    <Layout>
      <section className='children-content'>
        ...
        <Modal handleOpen={handleOpenEdit} handleClose={handleCloseEdit} 
          open={state.openEdit} >
          <div className='modal-add-content'>
            <label className='modal-help'> Editar producto.</label>
            <FormControl variant='standard' className='modal-form-control'>
              <InputLabel htmlFor='input-with-icon-adornment'>
                Nombre del producto
              </InputLabel>
              <Input value={state.product.name} name='name'
                onChange={onChangeProductEdit} placeholder='Ingresa el nombre'
                startAdornment={
                  <InputAdornment position='start'>
                    <TextFormatIcon />
                  </InputAdornment>
            ...
            <FormControl variant='standard' className='modal-form-control'>
              ...
              <Input value={state.product.cost} name='cost'
                onChange={onChangeProductEdit} placeholder='Ingresa el costo'
                startAdornment={<InputAdornment position='start'><MonetizationOnIcon /> </InputAdornment>}
              />
            </FormControl>
            <FormControl variant='standard' className='modal-form-control'
              ...
              <Input value={state.product.iva} name='iva'
                onChange={onChangeProductEdit} placeholder='El IVA se calcula automaticamente'
                startAdornment={
                  <InputAdornment position='start'>
                    <MonetizationOnIcon />
                  </InputAdornment>
            ...
            <FormControl variant='standard' className='modal-form-control'>
              ...
              <Input value={state.product.price} name='price'
                onChange={onChangeProductEdit} placeholder='Ingresa el precio'
                startAdornment={
                  <InputAdornment position='start'>
                    <MonetizationOnIcon />
                  </InputAdornment>
